...
@section('content')
    <div class="container-fluid py-4">
        ...
        {{-- Filters --}}
        <form method="GET" action="{{ route('admin.daily-reports.clients-without-report') }}"
            class="card shadow-sm border-0 mb-4">
            <div class="card-body">
                <div class="row g-3 align-items-end">
                    <div class="col-md-5">
                        <label class="form-label fw-semibold">البحث بالاسم أو رقم المعرف</label>
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a href="{{ route('admin.daily-reports.clients-without-report') }}"
